...
/**
 * @brief Template de l'algorithme Taged-F.
 * 
 * @tparam TAfficheur 
 */
template <typename TAfficheur>
/**
 * @brief Algorithme Taged-F.
 * 
 */
class TagedF : public AlgoCube<TAfficheur>
{
...
public:
	/**
	 * @brief Construct a new TagedF object
	 * 
	 * @param R 
	 * @param Out 
	 * @param MinSeuil1 
	...
	/**
	 * @brief Destroy the TagedF object
	 * 
	 */
	~TagedF()
	{
...
template <typename TAfficheur>
void TagedF<TAfficheur>::Calculer(unsigned int indexDataIn[], unsigned int taille)
{
	++NbBottomUpCubeCall;
...
template <typename TAfficheur>
void TagedF<TAfficheur>::Calculer_rec(unsigned int indexDataIn[],
		unsigned int taille,
		unsigned int dim,
		unsigned int profondeur,
		Phase pCour)
