...
class RandomTeams extends Dex.ModdedDex {
	...
	generateTeam() {
		const generatorName = typeof this.format.team === 'string' && this.format.team.startsWith('random') ? this.format.team + 'ReplayParser' : '';
		// @ts-ignore
	...
	randomTeam() {
		...
		while (pokemonPool.length && pokemon.length < 6) {
			...
			// ReplayParser has Mega/weather/hazards
